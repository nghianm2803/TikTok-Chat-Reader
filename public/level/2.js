oS.Init({
    ...
    StartGame: function () {
        ...
        (function (e, h, b, d, c, g, a, f) {
            ...
            h += 16;
            d += 16;
            $CFun("sod3row").style.clip = "rect(0," + e + "px,330px,0)";
            SetStyle($CFun("SodRoll_1"), {left: h + "px", width: --b + "px", height: "141px"});
            SetStyle($CFun("SodRoll_2"), {left: h + "px", width: b + "px", height: "141px"});
            SetStyle($CFun("SodRollCap_1"), {left: d + "px", width: --c + "px", height: --g + "px", top: ++a + "px"});
            SetStyle($CFun("SodRollCap_2"), {left: d + "px", width: c + "px", height: g + "px", top: ++f + "px"});
            e < 766 ? oSym.addTask(3, arguments.callee, [e, h, b, d, c, g, a, f]) : (ClearChild($CFun("SodRoll_1"), $CFun("SodRoll_2"), $CFun("SodRollCap_1"), $CFun("SodRollCap_2")), (function () {
                ...
                PrepareGrowPlants(function () {
                    ...
                    oP.Monitor({
                        ar: [0], f: function (l) {
                            ...
                            switch (l) {
                                case 0:
                                    innerText($CFun("DivTeach"), "Hướng dương là cực kỳ quan trọng, và nói chung các loài ngoài cùng bên trái");
                                ...
                                case 1:
                                    ...
                                    for (i in j) {
                                        if (j[i].EName == "oSunFlower") {
                                            innerText($CFun("DivTeach"), "Ít nhất là ba hoa hướng dương trồng！");
                                ...
                                case 2:
                                    ...
                                    k > 1 && (innerText($CFun("DivTeach"), "Hướng dương, bạn càng nhận được, nhanh hơn mặt trời！"), ++l);
                                    oSym.addTask(10, arguments.callee, [l]);
                                    break;
                                default:
                                    var j = oGd.$, i, k = 0;
                                    ...
                                    k > 2 ? (innerText($CFun("DivTeach"), "Bây giờ bạn có được ánh nắng mặt trời với đất trồng cây khác！"), SetStyle($CFun("PointerUD"), {
                                        left: "50px",
                                        top: "60px"
                                    }), oSym.addTask(500, SetNone, [$CFun("PointerUD"), $CFun("DivTeach")])) : oSym.addTask(10, arguments.callee, [3])
                            }
                            return l
                        }
                    });
    ...
    FlagToEnd: function () {
        ...
        EditImg($CFun("PointerUD"), 0, "images/interface/PointerDown.gif", {left: "836px", top: "185px", display: "block"})
    }
});
